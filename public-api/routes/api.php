...
Route::get('/foodNutrients/{foodId}', ['uses' => 'FoodNutrientController@show']);
Route::get('/foodNutrients/', ['uses' => 'FoodNutrientController@index']);

Route::get('/nutrientsDetails/{id}', ['uses' => 'NutrientsController@show']);
